...
const routes = [
    ...
    { path: "/project/:id", redirect: "/project/:id/overview", props: true, component: ProjectLayout, children: [
    ...
    { path: "/debug", redirect: "/debug/logs", component: DebugLayout, children: [
      { path: "logs", name: "debug-logs", component: DebugLogs },
      { path: "state", name: "debug-state", component: DebugState },
    ] },
    { path: "/settings", redirect: "/settings/appearance", component: SettingsLayout, children: [
