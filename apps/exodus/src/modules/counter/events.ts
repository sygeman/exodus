...
export const counterRegistry: EventoRegistry = {
  ...
  "counter:updated": { schema: z.object({ count: z.number(), autoIncrement: z.boolean() }), description: "Counter value updated" },
  ...
  "counter:query": { schema: z.object({ correlation_id: z.string().optional() }), description: "Query counter state" },
}
