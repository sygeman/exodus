  ...
  flows: [
    {
      ...
      nodes: [
        { id: "n1", type: "trigger", position: { x: 0, y: 0 } },
        {
          ...
          type: "action",
          position: { x: 100, y: 0 },
          data: { module: "electrobun", proc: "checkUpdate" },
        },
      ],
    ...
    },
    {
      ...
      nodes: [
        { id: "n1", type: "trigger", position: { x: 0, y: 0 } },
        {
          ...
          type: "action",
          position: { x: 100, y: 0 },
          data: { module: "electrobun", proc: "saveWindowFrame" },
        },
      ],
      edges: [{ id: "e1", source: "n1", target: "n2" }],
    ...
    },
    {
      ...
      nodes: [
        { id: "n1", type: "trigger", position: { x: 0, y: 0 } },
        {
          ...
          type: "action",
          position: { x: 100, y: 0 },
          data: { module: "electrobun", proc: "saveRoute" },
        },
      ],
      edges: [{ id: "e1", source: "n1", target: "n2" }],
    ...
    },
    {
      ...
      nodes: [
        { id: "n1", type: "trigger", position: { x: 0, y: 0 } },
        {
          ...
          type: "action",
          position: { x: 100, y: 0 },
          data: { module: "electrobun", proc: "saveSetting" },
        },
      ],
      edges: [{ id: "e1", source: "n1", target: "n2" }],
